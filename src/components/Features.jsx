                            ...
                            <div className="feature-text-container">
                                <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">
                                        ...
                                        <span> using the same alloy that spacecrafts use for their missions to Mars.</span>
                                    </p>
                                </div>

                                <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">
                                        Titanium has one of the best strength-to-width of any metal, making these our {' '}
